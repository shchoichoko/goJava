...
public class ReportSheet {
	...
	static ArrayList<OneRec> k41_ArrayOneRec = new ArrayList<OneRec>();
	...
	static final int k41_iPerson = 50; //입력할 인원수
	static final int k41_peoplePerPage = 9;	// 페이지당 출력되는 인원수
	...
	public static void dataSort() { // 데이터 정렬을 위한 함수.
		Comparator<OneRec> k41_com = new Comparator<OneRec>() {
			//비교를 위해 Comparator 선언.
			public int compare(OneRec k41_a1, OneRec k41_a2) {
				//비교할 두 값을 매개변수에 넣는다.
				//성적의 총점을 비교한다.
	...
	public static void dataSet() {	// 데이터를 순서대로 ArrayList에 저장하는 함수.
		for (int k41_i = 0; k41_i < k41_iPerson; k41_i++) {
			...
			k41_ArrayOneRec.add(new OneRec(k41_i, k41_name, k41_kor, k41_eng, k41_mat));
	...
	public static void itemPrint(int k41_i) {
		...
		OneRec k41_rec;//OneRec2의 데이터를 불러오기 위해 객체 선언.
