...
public class ReportSheet {
	...
	static int k41_iPerson = 23; // 배열 크기를 설정. 
	static int k41_printPerson = 4;	//페이지당 인원수
	static int k41_totalPageNum = k41_iPerson/k41_printPerson;	//총 페이지 수
	static int k41_lastPeople = k41_iPerson % k41_totalPageNum;	//마지막 페이지에 남은 인원 수 
	static int k41_startNum = k41_totalPageNum * k41_printPerson;
	static InputData k41_inData = new InputData(k41_iPerson,k41_totalPageNum); // InputData 클래스의 객체 생성
