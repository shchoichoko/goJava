...
public class GetDistanceToGangNamStationByPublicTransport {
	...
	public static void main(String[] args) throws IOException {
		...
		File k41_f1 = new File("C:\\Users\\폴리텍\\Desktop\\SooHyeok\\GetToGangNamStation\\DistanceToGangNamStationByPublicTransport.csv");
		...
		while((k41_readtxt = k41_br.readLine())!=null) {	//
			...
			// 엔터 누르기
			driver.findElement(By.xpath("/html/body/app/layout/div[3]/div[2]/shrinkable-layout/div/directions-layout/directions-result/div[1]/div/directions-search/div[2]/button[2]"))
					.sendKeys(Keys.ENTER);
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
			...
			driver.findElement(By.xpath("/html/body/app/layout/div[3]/div[2]/shrinkable-layout/div/directions-layout/directions-result/div[1]/div/directions-search/div[2]/button[2]")).click();
			try { // 길찾기 누르기
				Thread.sleep(1000);
			} catch (InterruptedException e) {
			...
			driver.findElement(By.xpath("/html/body/app/layout/div[3]/div[2]/shrinkable-layout/div/directions-layout/directions-result/div[1]/directions-summary-list/directions-hover-scroll/div/ul/li[1]/directions-summary-item-pubtransit/div[1]/em")).click();
			try { // 최적 누르기
				Thread.sleep(1000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			try {
					...
					tt = driver.findElement(By.xpath(
							"/html/body/app/layout/div[3]/div[2]/shrinkable-layout/div/directions-layout/directions-result/div[2]/directions-details-result/directions-details-summary-pubtransit/div/div/strong/readable-duration/span[1]")).getText();
