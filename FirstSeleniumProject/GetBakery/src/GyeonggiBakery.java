...
public class GyeonggiBakery {
	...
	public static void main(String[] args) throws IOException {
		...
		FileOutputStream output = new FileOutputStream("C:\\Users\\폴리텍\\Desktop\\수혁\\Data\\GyeonggiBakery2.csv");
		...
		for (int i = 0; i < 3; i++) {
			if (i == 0)
				...
				driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[1]/div/div[3]/form/fieldset/div/input"))
						.sendKeys("경기도 빵 맛집");// 경기도 빵 맛집 입력
			else
				driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[1]/div/div[3]/form/fieldset/div/input"))
						.sendKeys(Keys.ENTER);// 엔터 누르기
			try {
				Thread.sleep(1500);
